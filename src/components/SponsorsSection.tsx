...
const SponsorsSection = () => {
  return (
    <section className="relative py-24 bg-[#0E0E14] overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-[#1E4FFF] rounded-full opacity-20 blur-xl" />
        <div className="absolute top-10 left-10 w-60 h-60 bg-[#1E4FFF] transform rotate-45 opacity-10 blur-xl" />
    ...
    <div className="container px-4 mx-auto relative z-10">
      ...
      >
        <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium tracking-wider text-white rounded-md bg-[#1E4FFF]">
          스폰서
        </span>
        <h2 className="text-3xl md:text-6xl font-extrabold text-white mb-6 leading-tight uppercase">
          함께하는 <span className="text-[#1E4FFF]">파트너사</span>
        </h2>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-[#1E4FFF] mb-8 flex items-center justify-center gap-2 uppercase">
            <HandshakeIcon className="h-6 w-6" /> Platinum 스폰서
          </h3>
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            {sponsors
              ...
              .map((sponsor, index) => (
                ...
                >
                  <Card className="bg-[#15151E] backdrop-blur-sm border-[#1E4FFF]/20 h-full transform hover:translate-y-[-5px] transition-transform duration-300">
              ...
              >
                <Card className="bg-[#15151E] backdrop-blur-sm border-[#1E4FFF]/20 h-full transform hover:translate-y-[-5px] transition-transform duration-300">
                  <CardContent className="p-6 flex flex-col items-center justify-center">
                    <div className="bg-white p-3 rounded-lg mb-3 w-36 h-20 flex items-center justify-center">
                      <img 
                        src={sponsor.logo} 
                        alt={`${sponsor.name} 로고`}  
                        className="max-w-full max-h-full object-contain" 
