                ...
                >
                  <Card className="bg-white/10 backdrop-blur-sm border-white/10 h-full transform hover:translate-y-[-5px] transition-transform duration-300">
                    <CardContent className="p-8 flex flex-col items-center justify-center">
                      <div className="bg-white/90 p-4 rounded-xl mb-4 w-48 h-24 flex items-center justify-center">
                        <img 
                          src={sponsor.logo} 
                          alt={`${sponsor.name} 로고`} 
              ...
              >
                <Card className="bg-white/10 backdrop-blur-sm border-white/10 h-full transform hover:translate-y-[-5px] transition-transform duration-300">
                  <CardContent className="p-6 flex flex-col items-center justify-center">
                    <div className="bg-white/90 p-3 rounded-lg mb-3 w-36 h-20 flex items-center justify-center">
                      <img 
                        src={sponsor.logo} 
                        alt={`${sponsor.name} 로고`}  
                        className="max-w-full max-h-full object-contain" 
