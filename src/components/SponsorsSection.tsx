    ...
    <section className="relative py-24 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-32 left-1/4">
          ...
          <div className="w-4 h-4 bg-[#2277FF] border border-white absolute top-0 right-4"></div>
          <div className="w-12 h-4 bg-[#2277FF] border border-white absolute top-4 left-0"></div>
          <div className="w-8 h-4 bg-[#2277FF] border border-white absolute top-8 left-2"></div>
          <div className="w-4 h-4 bg-[#2277FF] border border-white absolute top-12 left-4"></div>
        </div>
        
        {/* Pixelated trophy */}
        <div className="absolute top-40 right-1/4">
          <div className="w-8 h-4 bg-[#2277FF] border border-white absolute top-0 left-2"></div>
          <div className="w-4 h-8 bg-[#2277FF] border border-white absolute top-4 left-4"></div>
          <div className="w-12 h-4 bg-[#2277FF] border border-white absolute top-12 left-0"></div>
        </div>
    ...
    <div className="container px-4 mx-auto relative z-10">
      ...
      >
        ...
        <h2 className="text-4xl md:text-7xl font-black text-white mb-6 leading-none tracking-tight uppercase">
          <span className="text-[#2277FF]">파트너사</span>와 함께하는 대회
        </h2>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="text-2xl font-black text-white mb-8 flex items-center justify-center gap-2 uppercase">
            <BadgeCheck className="h-8 w-8 text-[#2277FF]" /> 
            <span className="bg-[#2277FF] px-3 py-1 transform -rotate-2 text-black">Platinum 스폰서</span>
          </h3>
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            {sponsors
              ...
              .map((sponsor, index) => (
                ...
                >
                  <Card className="bg-black border-2 border-[#2277FF] h-full shadow-[8px_8px_0px_0px_rgba(34,119,255,0.3)] transform hover:-translate-y-2 transition-transform duration-300">
                    <CardContent className="p-8 flex flex-col items-center justify-center">
                      <div className="bg-[#111] p-4 rounded-xl mb-4 w-48 h-24 flex items-center justify-center border-2 border-[#2277FF]">
                        <img 
                          src={sponsor.logo} 
                          alt={`${sponsor.name} 로고`} 
        ...
        <div>
          <h3 className="text-xl font-black text-white mb-8 flex items-center justify-center gap-2 uppercase">
            <BadgeCheck className="h-6 w-6 text-[#2277FF]" /> 
            <span className="bg-[#2277FF] px-3 py-1 transform rotate-1 text-black">Gold 스폰서</span>
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            {sponsors
              ...
              .map((sponsor, index) => (
                ...
                >
                  <Card className="bg-black border-2 border-[#2277FF] h-full shadow-[6px_6px_0px_0px_rgba(34,119,255,0.3)] transform hover:-translate-y-2 transition-transform duration-300">
                    <CardContent className="p-6 flex flex-col sm:flex-row items-center justify-between">
                      <div className="bg-[#111] p-3 rounded-lg mb-3 sm:mb-0 w-36 h-20 flex items-center justify-center border-2 border-[#2277FF]">
                        <img 
                          src={sponsor.logo} 
                          alt={`${sponsor.name} 로고`}  
                          className="max-w-full max-h-full object-contain" 
                      ...
                      <div className="text-center sm:text-right">
                        <span className="inline-block px-2 py-1 text-xs rounded bg-[#2277FF] text-black border border-white mb-2">
                          {sponsor.level}
                        </span>
